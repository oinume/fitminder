...
func (v *Vars) IsProductionEnv() bool {
	return v.AppEnv == "production"
}

func (v *Vars) IsDevelopmentEnv() bool {
	return v.AppEnv == "development"
}
...
func (v *Vars) StaticURL() string {
	if v.IsProductionEnv() {
		return "https://asset.fitminder.lampetty.net/static/" + v.VersionHash
	} else if v.IsDevelopmentEnv() {
		return "http://asset.development.fitminder.lampetty.net/static/" + v.VersionHash
	} else {
...
func (v *Vars) WebURL() string {
	if v.IsProductionEnv() {
		return "https://fitminder.lampetty.net"
	} else if v.IsDevelopmentEnv() {
		return "https://development.fitminder.lampetty.net"
	} else {
